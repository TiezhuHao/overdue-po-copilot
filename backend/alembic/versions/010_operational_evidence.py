"""Create corrected Phase 5C operational facts (independent migration DDL)."""
import sqlalchemy as sa
from sqlalchemy.dialects import postgresql
from alembic import op

revision = '010_operational_evidence'
down_revision = '009_forecast_evidence'
branch_labels = None
depends_on = None
...
def table(name, key, *items):
    ...
    return op.create_table(name, *columns, schema='platform')
...
def downgrade():
    for name in ["stockpile_inventory_age_buckets","stockpile_balance_projections","stockpile_forecasts","stockpile_records","stockpile_versions","supply_demand_components","supply_demand_snapshots","inventory_age_buckets","inventory_snapshots"]:
